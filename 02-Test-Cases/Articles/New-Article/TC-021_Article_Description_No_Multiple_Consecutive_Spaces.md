# TC-021 - Article Description Should Not Contain Multiple Consecutive Spaces

## Steps
1. Open the Conduit application
2. Log in with valid credentials
3. Navigate to "New Article"
4. Enter a description with multiple consecutive spaces (e.g., "Description  with   multiple   spaces")
